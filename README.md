...
# About
This repository is a starter template for compiling raw .NET IL (`.il`) code directly.
The `primespeed.il` file (a simple prime number finder) is included as an example.

**Note:** This most likely won't be faster than equivalent C# code. It's just for learning.
